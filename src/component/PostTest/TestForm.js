...
const TestForm = () => {
    ...
    const submitForm=(e)=>{
        ...
        axios.post('http://localhost:5000/testOrders', appointment)
        .then(function (res) {
    ...
    return (
        ...
        <div className="form-text">
            ...
            <p>Select Your Suitable Test Here</p>
        </div>
        <div className="main-form">
            <form onSubmit={submitForm} method="get">
                ...
                {/* this is the select option */}
                    <span>Test Name ?</span>
                    <input onChange={getData} type="text" name="test" id="test" placeholder="Write Test name here..." required />
                    {/* this is the select option */}
                </div>
                <div>
                    <span>What time ?</span>
